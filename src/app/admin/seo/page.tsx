    ...
    try {
      ...
      if (res.ok) {
        ...
        const defaultKeywords: { [key: string]: string } = {
          'bao-gia-decal-dan-ly-giu-nhiet-si-le': 'in decal dán ly',
          'bao-gia-in-tem-dan-xe-dien-hoc-sinh': 'in logo dán',
          'cac-loi-thuong-gap-khi-xuat-file-pdf-in-uv-dtf': 'in uv dtf',
          'cach-dan-decal-noi-3d-suon-xe-may-khong-bong': 'in logo dán',
          'cach-dan-logo-len-binh-giu-nhiet-son-tinh-dien': 'in uv dtf',
          'cach-dan-logo-mu-bao-hiem-nham-khong-bong': 'in logo dán mũ',
          'cach-dan-sticker-noi-3d-macbook-laptop-gaming': 'sticker uv dtf',
          'cach-tao-spot-color-spot-varnish-illustrator': 'in uv dtf',
          'cach-tao-spot-color-spot-white-photoshop': 'in uv dtf',
          'cong-nghe-in-decal-3d-noi-khoi-doc-dao': 'in decal 3d',
          'dan-logo-phan-quang-va-logo-noi-3d-xe-may': 'in uv dtf',
          'dan-tem-noi-3d-may-pha-cafe-may-hut-bui': 'in uv dtf',
          'decal-dan-non-bao-hiem-thong-thuong-va-uv-dtf': 'in uv dtf',
          'dia-chi-in-sticker-dan-laptop-theo-yeu-cau-lay-lien': 'sticker uv dtf',
          'dinh-dang-file-in-an-nhan-mac-tot-nhat': 'in uv dtf',
          'gia-in-decal-uv-dtf-chi-tiet-moi-nhat': 'in decal uv',
          'gia-may-in-tem-uv-dtf-va-kinh-nghiem-dau-tu': 'giá máy in tem uv dtf',
          'huong-dan-chon-sticker-dan-hop-tai-nghe-airpods': 'in uv dtf',
          'huong-dan-chon-tem-dan-binh-giu-nhiet-chong-troc-son': 'in logo dán',
          'huong-dan-dan-tem-uv-dtf-dung-cach': 'in uv dtf',
          'huong-dan-thiet-ke-file-in-uv-dtf-ai': 'in uv dtf',
          'huong-dan-xuat-file-in-uv-dtf-coreldraw': 'in uv dtf',
          'in-decal-7-mau-hologram-bat-sang-doc-dao': 'in decal 7 màu',
          'in-decal-dan-ly-su-qua-tang-noi-3d': 'in decal dán ly',
          'in-decal-dan-mu-bao-hiem-quang-cao-gia-re': 'in decal dán mũ',
          'in-decal-dtf-va-decal-uv-dtf-co-gi-khac-nhau': 'giá in tem uv dtf',
          'in-logo-dan-binh-giu-nhiet-qua-tang-dai-hoi': 'in uv dtf',
          'in-logo-dan-chai-lo-thuy-tinh-my-pham': 'in logo dán chai',
          'in-logo-dan-chai-thuy-tinh-nuoc-ep-tra-sua': 'in logo dán chai',
          'in-logo-dan-hu-nen-thom-thuy-tinh-chiu-nhiet': 'đặt in logo dán',
          'in-logo-dan-ly-su-uong-tra-van-phong': 'in logo dán ly',
          'in-logo-dan-mu-bao-hiem-chuyen-nghiep-gia-re': 'in logo dán mũ',
          'in-logo-dan-tu-lanh-decal-noi-3d-sang-trong': 'đặt in logo dán',
          'in-logo-dan-xe-may-decal-uv-dtf-3d-chong-phai-mau': 'in logo dán xe',
          'in-logo-dan-xe-may-decal-uv-dtf-noi': 'in logo dán xe',
          'in-logo-decal-dan-ly-nhua-tra-sua-lay-nhanh': 'in uv dtf',
          'in-sticker-dan-binh-nuoc-hoc-sinh-chong-nuoc': 'in uv dtf',
          'in-sticker-dan-dien-thoai-thiet-ke-rieng': 'in uv dtf',
          'in-sticker-dan-laptop-chong-nuoc-chong-xuoc': 'in uv dtf',
          'in-sticker-dan-mu-bao-hiem-chong-nang-mua': 'in uv dtf',
          'in-sticker-dan-non-bao-hiem-nua-dau-san-bong': 'in uv dtf',
          'in-sticker-uv-dtf-theo-yeu-cau-lay-lien-gia-re': 'in uv dtf',
          'in-tem-dan-chai-ruou-vang-thuy-tinh-3d': 'in uv dtf',
          'in-tem-dan-chai-tinh-dau-serum-chong-dau': 'in uv dtf',
          'in-tem-dan-hu-my-pham-thuy-tinh-handmade': 'in uv dtf',
          'in-tem-dan-hu-nen-thom-doc-dao': 'in uv dtf',
          'in-tem-dan-ly-giu-nhiet-chong-nuoc-sieu-ben': 'in uv dtf',
          'in-tem-dan-ly-giu-nhiet-so-luong-it-lay-ngay': 'in uv dtf',
          'in-tem-dan-ly-thuy-tinh-khong-vien': 'in uv dtf',
          'in-tem-logo-noi-3d-dan-coc-giu-nhiet': 'in uv dtf',
          'in-tem-noi-uv-dtf-phu-bong-varnish-cao-cap': 'in tem nổi uv dtf',
          'in-uv-dtf-dan-binh-giu-nhiet-qua-tang-doanh-nghiep': 'in uv dtf',
          'kinh-nghiem-in-logo-dan-binh-giu-nhiet-qua-tang': 'đặt in logo dán',
          'loi-sai-he-mau-cmyk-rgb-in-tem-nhan-3d': 'in uv dtf',
          'mau-sticker-dan-coc-thuy-tinh-bat-trend': 'in uv dtf',
          'mau-sticker-dan-laptop-it-lap-trinh-vien-3d': 'in uv dtf',
          'mau-sticker-dan-xe-may-cute-ca-tinh-di-phuot': 'in uv dtf',
          'mau-tem-dan-ly-thuy-tinh-quan-cafe-sang-chanh': 'in uv dtf',
          'meo-dan-file-ghep-in-decal-uv-dtf-kho-60cm': 'in decal uv',
          'meo-dan-trang-ghep-file-in-tem-uv-dtf-kho-30cm': 'in uv dtf',
          'meo-thiet-ke-file-in-uv-dtf-chuan-mau-sac-net': 'in uv dtf',
          'quy-trinh-san-xuat-tem-dan-non-bao-hiem': 'in uv dtf',
          'so-sanh-decal-cat-dan-truyen-thong-va-tem-uv-dtf': 'in decal cắt dán',
          'so-sanh-decal-skin-va-tem-uv-dtf-dien-thoai': 'in logo dán',
          'so-sanh-in-uv-dtf-noi-3d-va-in-uv-phang': 'in uv dtf',
          'so-sanh-khac-laser-va-dan-tem-uv-dtf-binh-giu-nhiet': 'in uv dtf',
          'sticker-cute-dan-mu-bao-hiem-cuc-chat': 'in uv dtf',
          'sticker-dan-binh-nuoc-tu-thiet-ke': 'in uv dtf',
          'sticker-dan-dien-thoai-noi-3d-sang-trong': 'in uv dtf',
          'sticker-dan-hop-qua-tang-go-phu-varnish': 'in uv dtf',
          'tem-dan-binh-nuoc-nhua-va-binh-inox': 'in uv dtf',
          'tem-uv-dtf-sieu-ben-ngoai-troi-do-ben-thoi-tiet': 'in uv dtf',
          'top-ly-giu-nhiet-dan-sticker-uv-dtf-dep': 'sticker uv dtf',
          'ung-dung-in-tem-nhan-decal-uv-dtf-doanh-nghiep': 'in tem nhãn decal uv dtf',
          'xu-huong-in-decal-3d-trang-tri-do-gia-dung-thong-minh': 'in decal 3d',
          'yeu-cau-he-mau-cmyk-in-tem-nhan-san-3d': 'in uv dtf',
        };
