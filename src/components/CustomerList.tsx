  ...
  return (
    <div className="w-full px-2 sm:px-4 py-6 sm:py-8">
      <div className="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* Filter Bar */}
        <div className="rounded-2xl border border-slate-200 bg-white p-3.5 sm:p-4 mb-6 flex flex-col sm:flex-row items-center gap-3 shadow-xs">
          ...
          <div className="flex w-full sm:w-auto gap-2">
            <button
              ...
              className="h-10 px-5 rounded-xl bg-slate-850 hover:bg-slate-950 text-white font-bold text-xs sm:text-sm transition-all cursor-pointer flex-1 sm:flex-initial text-center whitespace-nowrap"
            >
              Tìm kiếm
            </button>
          </div>
